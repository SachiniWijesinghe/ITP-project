...
<a href ={{"/search"}} class="btn-success">go to search</a><br>     <!--to go to search-->
<a href ={{"/issueDelivery"}} class="btn-success">Add Delivery</a>  <!--add additional diliveries-->
<a href ={{"/viewPendingDel"}} class="btn-success">view Pending Deliveries</a><br>  
<br>
<table class="table">
