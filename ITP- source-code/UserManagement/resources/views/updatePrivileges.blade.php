        ...
        <input type="hidden" name="id" value="{{$data['id']}}">
            <table  id="displaytable" width="100%" cellpadding="1" cellspacing="0">
                ...
                <tr>
                    ...
                    <td><button type="submit" class="btn btn-primary btn-lg active">Update</button></td>
                </tr>
            </table> 
    </form>
    <button type="submit" class="btn btn-secondary btn-lg active" onclick="window.location='{{ URL::previous() }}'">Cancel</button>
    </div>
                </div>
                </div>
            </section>
