                ...
                <form action="/view-items" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cAmount" placeholder="Enter Cost Amount">
                    </div>
                    <div class="form-group">
                        <label for="">Real Price</label>
                        <input type="text" class="form-control" name="realPrice" placeholder="Enter Real Price">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sellPrice" placeholder="Enter Selling Price">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="0" class="form-control" name="discription" placeholder="Enter Quntity">
                        </div>
                    </div>
                    </div>
                    <!-- /.card-body -->
