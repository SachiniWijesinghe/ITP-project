                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Add Return Items</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                  ...
                                  @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="Code" placeholder="Enter Item Code">
                                        @error('Code')
                                         <div class="alert-denger">{{ $errors->first('Code') }}</div>
                                         @enderror
                                        </div>
                                        ...
                                        @error('Name')
                                         <div class="alert-denger">{{ $errors->first('Name') }}</div>
                                         @enderror
                                        </div>


                                        <div class="form-group">
                                            <label for="">Reason to Return</label>
                                            <input type="text" class="form-control"   name="Reason"  placeholder="Enter your Reason">
                                            @error('Reason')
                                         <div class="alert-denger">{{ $errors->first('Reason') }}</div>
                                         @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"   name="Quntity"  placeholder="Enter Quntity">
                                            @error('Quntity')
                                         <div class="alert-denger">{{ $errors->first('Quntity') }}</div>
                                         @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            @error('Price')
                                         <div class="alert-denger">{{ $errors->first('Price') }}</div>
                                         @enderror
