                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../contact/91" position = "absolute"><font size="3" >  Contact us         </font></a>
                      </li>
      ...
      <div class="item col-xs-4 col-lg-4">
        <div class="thumbnail card">
          ...
          <div class="caption card-body">
            ...
            <p class="card-text" style="font-size: 14px">18, Kadana Road, Dehiwala, Sri Lanka.</p>
            <p class="card-text" style="font-size: 14px">0112739583</p>
            <p class="card-text" style="font-size: 14px">super@fashion.lk</p>
