...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('about/' .$abouts->id) }}" method="post">
        ...
        <label>Name</label></br>
        <input type="text" name="Name" id="Name" value="{{$abouts->Name}}" class="form-control" required></br>
        <label>Email</label></br>
        <input type="email" name="Email" id="Email" value="{{$abouts->Email}}" class="form-control" required></br>
