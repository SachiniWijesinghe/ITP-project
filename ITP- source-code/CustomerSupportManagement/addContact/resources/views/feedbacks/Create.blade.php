                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="../about/84"  position = "absolute"><font size="3" > About us</font></a>
                      </li>
...
<div class="bg-image" 
      style="background-image: url('/images/feedback.png');
            ...
            @if(session('status'))
        <h1 class =  "alert alert-success alert-dismissible" style="text-align: center;">{{session('status')}}</h1>
        @endif
  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <!-- Content -->
        <h2 class="font-weight-bold text-uppercase mb-4"><b>Super Fashion</b></h2>
      ...
      <div class="col-md-4 col-lg-3 mx-auto my-md-4 my-0 mt-4 mb-1">
       ...
       <!-- Links -->
       <h2 class="font-weight-bold text-uppercase mb-4" style = "text-align:justify;"><b>USEFUL LINKS</b></h2>
...
<!-- Contact details -->
<h2 class="font-weight-bold text-uppercase mb-4" style = "text-align:justify;"><b>Store</b></h2>

<ul class="list-unstyled" style = "text-align:justify;">
  <li>
    <p style = "text-align:justify; font-size:15px;">
      <i class="fa fa-female mr-11"></i> Women</p>
  </li>
  <li>
    <p style = "text-align:justify; font-size:15px;">
 ...
 <div class="col-md-2 col-lg-1 text-center mx-auto my-4">
    <!-- Contact details -->
    <h2 class="font-weight-bold text-uppercase mb-4" style = "text-align:justify;"><b>Account</b></h2>
...
<ul class="list-unstyled" style = "text-align:justify;">
  ...
  <li>
    <p style = "text-align:justify;font-size:15px;">
      <i class="fa fa-heart mr-11"></i> Wishlist</p>
  </li>
  <li>
    <p style = "text-align:justify; font-size:15px;">
      <i class="fas fa-phone mr-11"></i> Orders</p>
        ...
        <!-- Social buttons -->
        <h2 class="font-weight-bold text-uppercase mb-4"><b>Follow Us</b></h2>
