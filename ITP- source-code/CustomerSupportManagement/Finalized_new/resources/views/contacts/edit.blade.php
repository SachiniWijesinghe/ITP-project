...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('contact/' .$contacts->id) }}" method="post">
        ...
        <input type="text" name="Title" id="Title" value="{{$contacts->Title}}" class="form-control" required></br>
        <label>Address</label></br>
        <input type="text" name="Address" id="Address" value="{{$contacts->Address}}" class="form-control" required></br>
        <label>Telephone</label></br>
        <input type="text" name="Telephone" id="Telephone" value="{{$contacts->Telephone}}" class="form-control" required maxlength="10"></br>
        <label>Email</label></br>
        <input type="email" name="Email" id="Email" value="{{$contacts->Email}}" class="form-control" required></br>
