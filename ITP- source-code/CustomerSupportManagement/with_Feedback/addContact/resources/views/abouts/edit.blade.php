...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('about/' .$abouts->id) }}" method="post">
        {!! csrf_field() !!}
        @method("PATCH")
        ...
        <input type="text" name="Email" id="Email" value="{{$abouts->Email}}" class="form-control"></br>
        <input type="text" name="Photo" id="Photo" value="{{$abouts->Photo}}"class="form-control" type="file"></br>
