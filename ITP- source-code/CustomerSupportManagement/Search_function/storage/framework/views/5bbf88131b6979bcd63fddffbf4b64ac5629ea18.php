...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="<?php echo e(url('contact/' .$contacts->id)); ?>" method="post">
        ...
        <input type="text" name="Title" id="Title" value="<?php echo e($contacts->Title); ?>" class="form-control"></br>
        <label>Address</label></br>
        <input type="text" name="Address" id="Address" value="<?php echo e($contacts->Address); ?>" class="form-control"></br>
        <label>Telephone</label></br>
        <input type="text" name="Telephone" id="Telephone" value="<?php echo e($contacts->Telephone); ?>" class="form-control"></br>
