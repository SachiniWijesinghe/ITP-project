...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
      ...
      <h6 class =  "alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss=".show">&times;</button> <?php echo e(session('status')); ?></h6>
      <?php endif; ?>
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="<?php echo e(url('generate-report')); ?>">
                        <!--button type="button" class="btn btn-success float-right py-1">Generate Report</button-->
                        </a>
...
<?php echo $__env->make('feedbacks.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\INSIGHT\OneDrive\Desktop\ITP\resources\views/feedbacks/index.blade.php ENDPATH**/ ?>