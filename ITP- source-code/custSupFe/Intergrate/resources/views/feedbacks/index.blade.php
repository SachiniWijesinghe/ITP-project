...
@section('content')
    ...
    <div class="container">
        <div class="row">
        @if(session('status'))
      <h6 class =  "alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss=".show">&times;</button> {{session('status')}}</h6>
      @endif
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/feedback/create') }}" class="btn btn-success btn-sm" title="Add New Contact">
                            ...
                            <table class="table">
                                ...
                                @foreach($feedbacks as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="{{ url('/feedback' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
