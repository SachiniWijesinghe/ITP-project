...
<div class="bg-image" 
      style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/98.jpg');
            height: 108vh">
              <div class="container">
            ...
            <div class="row " style="margin-top: 30px">
                ...
                <center> <h1 class="display-2">Feedback..!</h1></center> 
                    <h1 class="display-4">Please provide your feedback below:</h1>
