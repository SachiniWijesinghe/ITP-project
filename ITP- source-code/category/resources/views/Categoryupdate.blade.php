...
<div class="container-fluid">
    ...
    <div class="card shadow mb-5">
        ...
        <div class="card-body">
            <form id="Ctaegoryupdate" action="/Catupd" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                
                <div class="form-group">
                    
                    <input type="hidden" name="idCategory"  value="{{$Data1['idCategory']}}"  id="idCategory"  class="form-control">
